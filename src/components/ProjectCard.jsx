...
const projectImages = import.meta.glob('../assets/images/projects/*.{png,jpg,jpeg,gif}', { eager: true, import: 'default' });
...
export default function ProjectCard({ project, index }) {
  ...
  // Get the image URL from the imported images
  const imageUrl = projectImages[`../assets/images/projects/${project.image}`];
